    ...
    return (
      <div className="absolute z-10 flex w-full items-center justify-between p-4">
        <Link href={'/account'} className="flex items-center gap-2">
          <span className="text-xl text-slate-700">Cuenta Sueldo</span>
          <ChevronDownIcon className="h-5 text-slate-700" />
        </Link>

        <div className="flex items-center gap-2">
          <MoonIcon className="h-6 text-slate-700" />
          <UserIcon className="h-6 text-slate-700" />
          <Cog6ToothIcon className="h-6 text-slate-700" />
        </div>
      </div>
    );
  };
